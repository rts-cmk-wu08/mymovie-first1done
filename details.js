document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=184ef74a3cb2905d98fce7cf3ed1541e`)
    ...
    fetch(`https://api.themoviedb.org/3/movie/${id}/videos?api_key=184ef74a3cb2905d98fce7cf3ed1541e`)
    ...
    fetch(`https://api.themoviedb.org/3/movie/${id}/credits?api_key=184ef74a3cb2905d98fce7cf3ed1541e`)
        .then(response => response.json())
        .then(data => {
